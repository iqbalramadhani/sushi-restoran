...
export default function ProductCreate({ categories }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        router.post(route('products.store'), form, { preserveScroll: true, onError: (err) => setErrors(err), onSuccess: () => setForm({ category_id: '', name: '', price: '', description: '', is_available: true }) });
    };
